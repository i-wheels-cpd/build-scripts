...
#Apply patch
wget https://raw.githubusercontent.com/i-wheels-cpd/build-scripts/refs/heads/main/t/tensorflow/tf_2.18.1_fix.patch?token=GHSAT0AAAAAAC64LKZUF3S7AVIZVVPWVVTY2FC7K5A
git apply tf_2.18.1_fix.patch?token=GHSAT0AAAAAAC64LKZUF3S7AVIZVVPWVVTY2FC7K5A
