...
yum install -y python3.12 python3.12-pip git make cmake zlib-devel libjpeg-devel gcc gcc-c++ libevent libtool wget perl-Unicode-Normalize
...
#pyproject.toml
wget https://raw.githubusercontent.com/i-wheels-cpd/build-scripts/refs/heads/main/t/thrift/pyproject.toml
