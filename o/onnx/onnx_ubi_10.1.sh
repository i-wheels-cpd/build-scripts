...
yum install -y git make cmake clang python3.12 python3.12-devel python3.12-pip --exclude gstreamer1 --skip-broken
...
#Apply patch
wget https://raw.githubusercontent.com/i-wheels-cpd/build-scripts/refs/heads/main/o/onnx/onnx_1.21.0_fix.patch
...
#Install package
if ! (python3.12 -m pip install dist/onnx-1.21.0-cp312-abi3-linux_x86_64.whl) ; then
