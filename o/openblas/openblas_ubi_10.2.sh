...
yum install -y git make cmake wget python3.14 python3.14-devel python3.14-pip pkgconfig

yum install -y gcc-toolset-15
...
#building wheel
python3.14 -m pip wheel -v . --no-build-isolation --no-deps
