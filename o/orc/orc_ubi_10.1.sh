...
yum install -y wget git make cmake binutils lz4-devel zlib-devel \
    ...
    gcc gcc-c++ ninja-build tzdata

python3.12 -m pip install setuptools wheel ninja
...
wget https://raw.githubusercontent.com/i-wheels-cpd/build-scripts/refs/heads/main/o/orc/pyproject.toml
...
python3.12 -m pip install --upgrade build setuptools wheel
