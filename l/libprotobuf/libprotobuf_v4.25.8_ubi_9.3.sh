...
yum install -y make libtool cmake git wget xz zlib-devel openssl-devel bzip2-devel libffi-devel libevent-devel patch python python-devel python-pip ninja-build gcc-toolset-13
...
wget https://raw.githubusercontent.com/ramnathnayak-ibm/build-scripts-intel/refs/heads/libprotobuf/l/libprotobuf/pyproject.toml
